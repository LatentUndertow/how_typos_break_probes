#!/usr/bin/env python3
"""
Overnight runner: Repeat all key experiments on Qwen/Qwen3-8B.

Fully self-contained. No user interaction needed. Saves all results
to activation_robustness/results/qwen3_8b/<experiment_name>/.
...
N_LAYERS_TOTAL = 36
LAYERS = [9, 18, 27, 35]  # early, mid, late, last
D_MODEL = 4096
SEED_BASE = 100  # offset seeds from Llama runs
RESULTS_BASE = _REPO / "activation_robustness" / "results" / "qwen3_8b"
